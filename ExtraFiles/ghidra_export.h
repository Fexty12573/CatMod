...
namespace MH {
    ...
    namespace Chat {
        ...
        inline void** MainPtr = (void**)0x14500ac30; // 15.20
        inline void(*ShowGameMessage)(void*, const char*, float, uint, undefined1) = (void(*)(void*, const char*, float, uint, undefined1))0x141a53400; // 15.20
        namespace Unkn {
