...
#include <d3d11.h>
#include <dxgi.h>
#include <dti/cGUIObjChildAnimationRoot.h>
...
DECLARE_FUNCTION(MH::Player, SetActionSet, 0x141c186a0, void, void*, u32, ActionTable*, u32, u32)
...
DECLARE_POINTER(MH::Player, void*, StaticExePointer, 0x14500ab60) // 15.20
...
DECLARE_FUNCTION(MH::Monster::DamageBehavior, NextAction_, 0x1413966e0, void, void*, void*) // 15.20
...
DECLARE_FUNCTION(MH::Monster, GetTargetMonster, 0x141bad230, longlong, void*) // 15.20
...
DECLARE_FUNCTION(MH::Monster, SetTargetCoord, 0x141393ba0, void, void*, int, float*) // 15.20

/* Enrage Monster
arg1: pointer to structure owned by monster to be enraged (monster + 0x1BD08)
ret:  whether function succeeded or not */
DECLARE_FUNCTION(MH::Monster, Enrage, 0x1402a8120, bool, longlong) // 15.20

/* Unenrage Monster
arg1: same as enrage */
DECLARE_FUNCTION(MH::Monster, Unenrage, 0x1402a83b0, void, longlong) // 15.20
...
DECLARE_FUNCTION(MH::Monster, GetActionTableAt, 0x141390be0, ActionTable*, u32)
...
DECLARE_FUNCTION(MH::ActionController, ResizeActionSet, 0x14026aba0, void, void*, u32, u32, ActionTable*)
DECLARE_FUNCTION(MH::ActionController, SetActionSet, 0x141bfc1b0, void, void*, u32, ActionTable*, u32, int)
...
DECLARE_FUNCTION(MH::File, _LoadResource, 0x1422214f0, undefined8, void*, void*, char*, char) // 15.20
...
DECLARE_FUNCTION(MH::Debug, SpawnMonsterInit, 0x141a5a3e0, longlong, undefined8, ulonglong, ulonglong, char) // 15.20
...
DECLARE_POINTER(MH::Debug, undefined8*, SpawnVar, 0x14500ad00) // 15.20
DECLARE_POINTER(MH::sEnemy, undefined8*, Instance, 0x14500ad00) // 15.20
